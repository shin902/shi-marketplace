...
5. Any agent that estimates a task will flood its own context becomes a coordinator for it instead of doing it. Nesting depth emerges from data volume, not a fixed hierarchy.
